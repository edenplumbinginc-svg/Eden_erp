      ...
      <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: 'var(--space-4)' }}>
          ...
          <div style={{ textAlign: 'center', padding: 'var(--space-6)' }}>
            ...
            <div style={{ 
              ...
              <p style={{ color: 'var(--md-on-surface-variant)', marginBottom: 'var(--space-2)' }}>
                You're viewing EDEN as a guest. Some features require authentication.
              </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 'var(--space-4)' }}>
          <div className="card">
            ...
            <p style={{ color: 'var(--md-on-surface-variant)', marginBottom: 'var(--space-2)' }}>
              A comprehensive ERP system for EDEN, designed to streamline business operations with:
            </p>
